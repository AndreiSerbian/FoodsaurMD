-- Drop existing product-related tables that will be replaced
...
CREATE TABLE public.products (
  ...
  CONSTRAINT products_measure_unit_consistency CHECK (
...
CREATE POLICY "Producers can manage their products" ON public.products
  FOR ALL USING (
    producer_id IN (
