...
-- Add constraint for consistency
ALTER TABLE public.products 
ADD CONSTRAINT IF NOT EXISTS products_measure_unit_consistency CHECK (
...
CREATE INDEX IF NOT EXISTS idx_point_inventory_point_id ON public.point_inventory(point_id);
CREATE INDEX IF NOT EXISTS idx_point_inventory_product_id ON public.point_inventory(product_id);
CREATE INDEX IF NOT EXISTS idx_point_variants_point_product ON public.point_variants(point_id, product_id);
CREATE INDEX IF NOT EXISTS idx_point_variants_active ON public.point_variants(is_active);
