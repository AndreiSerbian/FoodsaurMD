...
const Dashboard = () => {
  ...
  const { categories: producerCategories, loading: categoriesLoading } = useProducerCategories(profile?.id)
          ...
          {!profile || editing ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="discount_available_time"
                  name="discount_available_time"
                  value={formData.discount_available_time}
                  onChange={handleChange}
            ...
            <div className="space-y-4">
              ...
              {profile.discount_available_time && (
                <div>
              ...
              {!categoriesLoading && producerCategories.length > 0 && (
                <div>
