  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        ...
        >
          <motion.h1 
            className="text-5xl md:text-6xl font-bold mb-2 text-gray-900"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <input
              ...
              className="w-full px-6 py-4 pr-12 text-gray-700 bg-white rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-200 transition-shadow duration-300"
            />
            <button
              type="submit"
