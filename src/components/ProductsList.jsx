...
const ProductsList = ({ producer }) => {
  ...
  const calculateDiscount = (regular, discounted) => {
    if (!discounted || !regular || discounted >= regular) return 0;
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-center mt-2">
            Скидки доступны {producer.discountAvailableTime || 'уточните время'}
          </p>
        </div>
        ...
        {!producer.products || producer.products.length === 0 ? (
          ...
          >
            {producer.products.map((product, index) => {
              ...
              const regularPrice = Number(product.priceRegular) || 0;
              const discountPrice = Number(product.priceDiscount) || 0;
                ...
                >
                  <div className="relative">
                    <img 
                      ...
                      alt={product.productName || 'Продукт'} 
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold mb-2">{product.productName || 'Без названия'}</h3>
