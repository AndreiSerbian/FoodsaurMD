      ...
      <div className="container mx-auto px-4">
        ...
        >
          {products.map((product, index) => (
            <motion.div key={index} variants={item} className="product-card">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <span className="text-lg font-bold text-gray-900">{product.priceDiscount} MDL</span>
                    {product.priceDiscount < product.priceRegular && (
                      <span className="text-sm text-gray-500 line-through ml-2">{product.priceRegular} MDL</span>
                    )}
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-primary text-white py-2 px-4 rounded-lg hover:bg-opacity-90 transition duration-300 flex items-center justify-center btn-hover"
                >
